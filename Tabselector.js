...
AFRAME.registerComponent('tabselector',{
  ...
  init: function(){
    ...
    window.addEventListener('keydown', function(evt){ 
      ...
      examPos.x -= selectedExaminable.components.examinable.data.centerOffset.x * 5.5;
      examPos.y -= selectedExaminable.components.examinable.data.centerOffset.y * 5.5;
      examPos.z -= selectedExaminable.components.examinable.data.centerOffset.z * 5.5;
